...
@section('content')
    ...
    <main class="padding-1">
        ...
        <div class="main-content">
            ...
            <!-- Create new user -->
            <livewire:admin.organizer.create title="{{ __('New organizer') }}"
                                       :hasSmallButton="false"
                                       :modalId="'m-create-organizer'">
            </livewire:admin.organizer.create>
                        ...
                        <td>
                            <div class="flex flex-row">
                                ...
                                @if(auth()->user()->hasRoles('super-administrator|administrator') )
                                    ...
                                    <!-- Delete tag -->
                                    <livewire:admin.organizer.delete title="{{ __('Delete organizer') }}"
                                                               :organizer="$organizer"
                                                               :hasSmallButton="false"
                                                               :modalId="'m-delete-organizer-' . $organizer->id"
                                    >
                                    </livewire:admin.organizer.delete>

                                    <!-- Update tag -->
                                    <livewire:admin.organizer.edit title="{{ __('Edit organizer') }}"
                                                             :organizer="$organizer"
                                                             :hasSmallButton="false"
                                                             :modalId="'m-edit-organizer-' . $organizer->id"
                                    >
                                    </livewire:admin.organizer.edit>
                                @endif
                            </div>
