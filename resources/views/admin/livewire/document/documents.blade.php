<div>
    <ul wire:sortable="updateOrder" class="no-bullets padding-left-right-0-5">
        @foreach ($documents as $document)
            <li wire:sortable.item="{{ $document->id }}" wire:key="document-{{ $document->id }}"
                class="border round border-light margin-bottom-1 padding-left-right-1">
                <div class="flex flex-row" style="justify-content: space-between;">
                    <div wire:sortable.handle class="flex-row" style="display:flex;align-items: center;cursor:move">
                    ...
                    <div class="button-group padding-top-bottom-1" style="align-items: center;">
                        <!-- View document -->
