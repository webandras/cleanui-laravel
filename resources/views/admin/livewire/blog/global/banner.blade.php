<article
    x-data="{ 'show': $wire.$entangle('show', true), 'style': $wire.$entangle('style', true), 'message': $wire.$entangle('message', true) }"
    ...
    <div class="notification-outer">
        <div class="notification-inner">
            <span :class="{ 'success': style === 'success', 'danger': style === 'danger' }"
                ...
                <i x-show="style !== 'success' && style !== 'danger'" class="fa fa-info-circle" aria-hidden="true"></i>
            </span>
